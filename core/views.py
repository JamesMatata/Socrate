...
from .models import Material, ChatSession, ChatMessage
    ...
    if request.method == 'POST':
        ...
        if uploaded_file:
            ...
            try:
                ...
                logger.info(f"Processing material of type: {material_type}")
                ...
                material.save()
                logger.info(f"Material processed and saved: {material.id}")
...
def upload_voice_message(request):
    if request.method == 'POST':
        ...
        if uploaded_file and chat_session_id:
            ...
            logger.error("No file uploaded or chat_session_id not provided")
